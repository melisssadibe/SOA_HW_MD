...
class PostServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CommentPost = channel.unary_unary(
                ...
                response_deserializer=post__pb2.Empty.FromString,
                _registered_method=True)
        self.ListPostComments = channel.unary_unary(
                '/posts.PostService/ListPostComments',
                request_serializer=post__pb2.ListPostCommentsRequest.SerializeToString,
                response_deserializer=post__pb2.ListPostCommentsResponse.FromString,
                _registered_method=True)
...
def add_PostServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListPostComments': grpc.unary_unary_rpc_method_handler(
                    servicer.ListPostComments,
                    request_deserializer=post__pb2.ListPostCommentsRequest.FromString,
                    response_serializer=post__pb2.ListPostCommentsResponse.SerializeToString,
            ),
    }
...
class PostService(object):
    ...
    def ListPostComments(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/posts.PostService/ListPostComments',
            post__pb2.ListPostCommentsRequest.SerializeToString,
            post__pb2.ListPostCommentsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
